...
{literal}
    ...
    function DpdInitIframe(){
        $('#{/literal}{if $container_id}{$container_id|escape:'htmlall':'UTF-8'}{else}HOOK_BEFORECARRIER{/if}{literal}').prepend('<iframe frameBorder="0" id="dpdIframe" src="module/dpdcarrier/dpdshoplocator" style="width:100%; height:0px;"> </iframe>')
    }
{/literal}
</script>
