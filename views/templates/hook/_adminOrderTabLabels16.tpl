...
<script>
    var DPD = new function() {
        ...
        var loadLabelInfo = function() {
            ...
            xhr.open("POST", "{html_entity_decode($controllerUrl|escape:'htmlall':'UTF-8')}", true);
        ...
        var getNewLabelRow = function(data) {
            ...
            pnLink.href = "{html_entity_decode($controllerUrl|escape:'htmlall':'UTF-8')}&action=download&selected_labels[]=" + data.parcel_number;
